...
onMounted(() => {
  document.body.setAttribute("data-layout-config", "{`darkMode`:false}");
});
</script>
<template>
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        ...
        <ul class="navbar-nav ms-auto align-items-center">
          <li class="nav-item me-0">
            <router-link :to="{ name: 'login' }" class="nav-link d-lg-none"
              >Sign In</router-link
            >
            <router-link
              :to="{ name: 'login' }"
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="text-center p-2 p-sm-3">
            ...
            <p class="text-muted mt-2 mb-0">
              Nam libero tempore, cum soluta a est eligendi minus id quod maxime
              placeate facere assumenda est.
            </p>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row pb-3 pt-5 align-items-center">
        <div class="col-lg-6 col-md-5">
          ...
          <a href="" class="btn btn-success rounded-pill mt-3"
            >Read More <i class="mdi mdi-arrow-right ms-1"></i
          ></a>
        </div>
            ...
            <div class="row mt-2">
              <div class="col-12 text-end">
                <button class="btn btn-primary">
                  Send a Message
                  <i class="mdi mdi-telegram ms-1"></i>
                </button>
              </div>
            </div>
          </form>
